...
export default function Home() {
  ...
  const [currentView, setCurrentView] = useState<'habits' | 'notes' | 'calendar'>('habits');
  ...
  return (
    <div className="flex">
      ...
      <main 
        className={`min-h-screen bg-[#121212] text-white p-4 flex-1 transition-all duration-300`}
        style={{
